...
TC Manager는 3개 컴포넌트로 구성되며, 각각 독립적으로 버전을 관리합니다.
...
```
TC Manager System  v0.5.0.0  (2026-03-19)
├── Frontend       v0.5.0.0
├── Backend        v0.5.0.0
└── Database       v0.3.0.0
```
...
*이 문서는 TC Manager의 모든 릴리즈 이력을 관리합니다. 새로운 배포 시 최상단에 새 버전을 추가하세요.*
