...
const s: Record<string, React.CSSProperties> = {
  ...
  infoBox: { fontSize: 14, lineHeight: 1.8, padding: "16px 20px", borderRadius: 8, backgroundColor: "var(--bg-card, #EFF6FF)", border: "1px solid var(--border-color, #BFDBFE)", marginBottom: 16 },
  ...
  archTitle: { fontSize: 15, fontWeight: 700, marginBottom: 12, color: "var(--accent, #7C2D12)" },
