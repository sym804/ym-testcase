    ...
    <div style={s.page}>
      ...
      <div style={s.container}>
        ...
        <nav style={s.toc}>
          ...
          <a href="#overview" style={s.tocItem}>1. 개요</a>
          <a href="#login" style={s.tocItem}>2. 로그인 / 회원가입</a>
          <a href="#project-list" style={s.tocItem}>3. 프로젝트 목록</a>
          <a href="#header" style={s.tocItem}>4. 헤더 / 네비게이션</a>
          <a href="#project-detail" style={s.tocItem}>5. 프로젝트 상세</a>
          <a href="#tc-manage" style={s.tocItem}>6. TC 관리</a>
          <a href="#testrun" style={s.tocItem}>7. 테스트 수행</a>
          <a href="#compare" style={s.tocItem}>8. 비교</a>
          <a href="#dashboard" style={s.tocItem}>9. 대시보드</a>
          <a href="#report" style={s.tocItem}>10. 리포트</a>
          <a href="#settings" style={s.tocItem}>11. 설정</a>
        ...
        <main style={s.main}>
          ...
          <section id="login" style={s.section}>
            <h2 style={s.h2}>2. 로그인 / 회원가입</h2>

            <h3 style={s.h3}>2-1. 로그인</h3>
          ...
          <section id="project-list" style={s.section}>
            <h2 style={s.h2}>3. 프로젝트 목록</h2>
            <p style={s.p}>로그인 후 첫 화면입니다. 전체 프로젝트 현황을 한눈에 파악할 수 있습니다.</p>

            <h3 style={s.h3}>3-1. 전체 현황 (Overview)</h3>
            ...
            <h3 style={s.h3}>3-4. 프로젝트 일괄 삭제</h3>
            <ul style={s.ul}>
          ...
          <section id="custom-fields" style={s.section}>
            ...
            <h3 style={s.h3}>16-2. 필드 관리 (설정 탭)</h3>
          ...
          <section id="test-plans" style={s.section}>
            <h2 style={s.h2}>17. 테스트 플랜 / 마일스톤</h2>
          ...
          {/* 18. CSV Import */}
          <section id="csv-import" style={s.section}>
            <h2 style={s.h2}>18. CSV Import (Jira / Xray / Zephyr)</h2>
            ...
            <h3 style={s.h3}>18-2. Jira 헤더 매핑</h3>
            <table style={s.table}>
              <thead>
          ...
          <section id="advanced-filter" style={s.section}>
            ...
            <h3 style={s.h3}>19-1. 필터 패널 열기</h3>
            <ol style={s.ol}>
            ...
            <h3 style={s.h3}>19-3. 필터 저장/불러오기</h3>
            <ul style={s.ul}>
